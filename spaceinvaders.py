...
class Ship(pygame.sprite.Sprite):
    ...
    def __init__(self, path, pos_x, pos_y, speed = 10):
        """
        Cria uma nave.
        ...
        self.__sound_shot = pygame.mixer.Sound(DIRECTORY + "/sounds/shoot.mp3")
        self.__ship_explosion = pygame.mixer.Sound(DIRECTORY + "/sounds/shipexplosion.mp3")
    ...
    def shoot(self):
        ...
        bullet = Bullet(self.rect.midtop, 3)
        return bullet
...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self, pos_xy, direction, color = SPRINGREEN, speed = 15):
        """
...
class SpaceInvaders():
    ...
    def home_screen(self):
        ...
        """
        menu = True
        music_menu = pygame.mixer.Sound(DIRECTORY + "/sounds/menu.mp3")
        music_menu.play(-1)

        text = self.font.render("SPACE INVADERS!", True, GREEN)
        self.font = self.create_font(20)
        command1 = self.font.render(" ENTER : INICIAR ", True, WHITE, None)
        command2 = self.font.render("   ESC : SAIR      ", True, WHITE, None)
    ...
    def final_screen(self):
        ...
        text1 = self.font50.render("Pontuação Final: %d" % self.score, True, GOLD)
        text2 = self.font20.render("Aperte ENTER para tentar novamente", True, WHITE)
        text3 = self.font20.render("Aperte ESC para sair", True, WHITE)
    ...
    def start_game(self):
        ...
        """
        music_level = pygame.mixer.Sound(DIRECTORY + "/sounds/menu.mp3")
        music_level.play(-1)
    ...
    def update(self):
        ...
        self.groups = pygame.sprite.Group(self.ship, self.ship_shot, self.invader_shot, self.invaders, self.left_edge, self.bottom_edge, self.right_edge, self.mystery)
        self.clock.tick(60)
        pygame.display.update()
